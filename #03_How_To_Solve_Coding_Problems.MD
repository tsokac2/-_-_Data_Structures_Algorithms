...
* **[Exercise: Coding Interview Question](#coding-q)**
...
### <a name="coding-q"> Exercise: Coding Interview Question</a>
...
**Should return**: ``true`` - because ``x`` is present in ``array1`` and ``array2``.
